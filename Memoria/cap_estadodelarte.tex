...
En numerosas ocasiones se relaciona dicho tipo de redes con la ciberdelincuencia. Esto es debido a que estas redes proporcionan un muy buen grado de privacidad y anonimato al usuario, lo cual es aprovechado para realizar actividades ilegales tales como la venta de armas ó drogas. 
...
Otro hecho importante es que el responsable de tratamiento de datos de los usuarios estará obligado a la notificación de cualquier fallo de seguridad que concierna a los usuarios a la Autoridad de Protección de Datos Local (en España es la Agencia Española de Protección de Datos).
