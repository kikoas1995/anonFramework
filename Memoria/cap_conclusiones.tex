...
\comments{Es de interés que destaques que la metodología aplicada es
  de interés en un ámbito de incipiente despliegue de dos estándares
  como el PSD-2 y el GDPR. El primero aplica a las entidades
  financieras, y les obliga a poner a disposición de los clientes sus
  datos, bien mediante API, bien mediante \emph{screen
    scraping}. Ahora bien, al hacer esto también se debe tener en
  mente la GDPR, esto es, la debida protección del dato
  privado. Aunque el TFG no está orientado a este ámbito específico,
  la investigación realizada permite abordar ese otro ámbito
  profesional que va a tener gran relevancia en un futuro casi inmediato.}
